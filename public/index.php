                    ...
                    <div class="form-group d-flex flex-column justify-content-center align-items-center">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            <label
                                ...
                                <input type="file" name="myfile" accept="image/*" style="width: 0;height: 0;" id="input1"
                                    multiple>
                            </label>
                    ...
                    <div class="form-group d-flex flex-column justify-content-center align-items-center">
                        ...
                        <form id="menuForm">
                            ...
                            <select class="form-select my-4 parentMenu">
                                ...
                                foreach ($result as $item) {
                                    ?>
                                    <option data-id="<?= $item['id'] ?>" value="<?= $item['id'] ?>"><?= $item['title'] ?></option>
                                    <?php
                                }
                                ?>
            ...
            <section class="slider">
                ...
                <div class="items">
                    <div class="item active">
                        <img src="http://localhost:8080//uploads/1082143573679aa9414134b.png" alt="lorestan">
                        <h2 class="title">Lorestan</h2>
                    </div>
                    <div class="item">
                        <img src="http://localhost:8080//uploads/925130934679aa9148a6da.png" alt="azerbaijan">
                    ...
                    <div class="item">
                        <img src="http://localhost:8080//uploads/1646876777679aaa5d8a619.jpg" alt="fars">
